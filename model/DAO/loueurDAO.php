...
class loueurDAO extends ConnexionMySQL {
    ...
    public function insertLoueur(loueur $loueur): bool {
        $sql = "INSERT INTO loueurs (id, nom, appelsKO, timeouts, motdepasse, pays, email, numTel, date) 
                VALUES (:id, :nom, :appelsKO, :timeouts, :motdepasse, :pays, :email, :numTel, :date)";
        $stmt = $this->bdd->prepare($sql);
